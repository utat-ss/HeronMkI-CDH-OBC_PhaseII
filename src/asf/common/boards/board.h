...
*
*	PURPOSE:
*	(Brief standard board header file). Includes the appropriate board header file
*	according to the defined board (parameter BOARD)
*
*	FILE REFERENCES:	compiler.h
*
*	EXTERNAL VARIABLES:		BOARD (parameter defined somewhere else)
*
