...
*
*	PURPOSE:
*	Controller Area Network (CAN) driver module for SAM. This file contains
*	several low level device drivers for CAN which are implemented in can_func.c
*
*	FILE REFERENCES:	can.h
*
