...
*
*	PURPOSE:
*	This file contains the includes required by can.c. This includes several
*	constant definitions which are used extensively in can_func.h. It also
*	includes the definition of the can_mb_conf_t structure which is used quite
*	often to implement CAN communication.
*
*
