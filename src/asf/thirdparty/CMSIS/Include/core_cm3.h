...
***********************************************************************
*	FILE NAME:		core_cm3.h
*
*	PURPOSE:
*	CMSIS Cortex-M3 Core Peripheral Access Layer Header File, V2.11, sep 8, 2011
*
...
*	None.
*
*	DESCRIPTION:	This file contains all the API which is specific to the Cortex-M Processors.
*	These API functions should be used as much as possible in order to make software more portable.
*
*	CORE_CMFUNC AND CORE_CMINSTR define the actual inctructions and functions you can use.
*
*	DEVELOPMENT HISTORY:
