...
*
*	PURPOSE:
*	Similar to queue.h, this file contains headers for definitions of functions and
*	types associated with semaphores.
*
*	FILE REFERENCES:	stddef.h, stdint.h, FreeRTOSConfig.h, projdefs.h, portable.h
*
