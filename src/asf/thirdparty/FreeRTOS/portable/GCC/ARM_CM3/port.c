...
*
*	PURPOSE:
*	This file is used to define functions that can be found on port.h, some are
*	related to the cm3 core, and others include the systick handler, and PendSV hander
*	for FreeRTOS.
*
*	FILE REFERENCES:	FreeRTOS.h, task.h
*
*	EXTERNAL VARIABLES:
*
...
/* This Handler is used when portNVIC_INT_CTRL_REG has been set to portNVIC_PENDSVSET_BIT by xPortSystickHandler.
** Don't be scared of the quotation marks, __asm volatile just indicates they are using assembly.	*/
