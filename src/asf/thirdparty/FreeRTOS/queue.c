...
*
*	PURPOSE:
*	This file contains the actual function definitions related to queues in FreeRTOS.
*
*	FILE REFERENCES:	stdlib.h, string.h, FreeRTOS.h, task.h, queue.h, croutine.h
*
